...
APP_ID = "58b0abda"
API_KEY = "b8d2375076cab5d524a2fa9fb226d3a0"
...
GOOGLE_SHEET_NAME = "My gym workout"
sheet_endpoint = "https://api.sheety.co/workout/MyGymWorkout/workouts"
...
for exercise in result["exercises"]:
    ...
    sheet_response = requests.post(
        sheet_endpoint,
        json=sheet_inputs,
        auth=("Unnati514", "uvpb12juh42323jnu568")
    )
